...
\dspdeclareoperator{dspshapetriangle}{
...
\tikzset{dspmultiplier/.style={shape=dspshapecircle,line cap=rect,line join=rect, line width=\dspblocklinewidth,minimum size=\dspoperatordiameter}}

%\tikzset{dspmultiplier/.style={shape=dspshapetriangle,line cap=rect,line join=rect,	line width=\dspblocklinewidth,minimum size=\dspoperatordiameter}}
