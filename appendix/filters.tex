...
Obie fazy wykonywane są cyklicznie, a~kompletny algorytm przedstawia rysunek \ref{fig:appx:KF:algorithm}.
	...
	\begin{tikzpicture}[>=latex']
		...
		{  
			\begin{tabular}{l}
				...
				\item Estymacja aktualnego stanu \eqref{eq:appx:KF:ph1a}            \\
				\item Estymacja kowariancji aktulnego stanu \eqref{eq:appx:KF:ph1b} \\
				\end{itemize}}                                                      
			\end{tabular} 
		};
		...
		{  
			\begin{tabular}{l}
				...
				\parbox{6.5cm}{                                                                     
				\begin{itemize}[leftmargin=*]                                                       
				\item {Wyznaczenie współczynnika wzmocnienia Kalmana \eqref{eq:appx:KF:ph2a}}     \\
				\item {Korekta estymacji stanu w~oparciu o~uzyskany pomiar \eqref{eq:appx:KF:ph2b}} \\
				\item {Obliczenie kowariancji błędu estymacji \eqref{eq:appx:KF:ph2c}}            \\
				\end{itemize}}                                                                      
			\end{tabular} 
		};    
		%% paths
...
\begin{figure}[!htb]
	...
	\subfigure[Wariant pracujący na szumie]
	{
		\begin{tikzpicture}[auto, thick, node distance=2cm, >=triangle 45]
			\tikzset{%
				block/.style    = {draw, thick, rectangle, minimum height = 3em,
