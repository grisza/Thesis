...
\begin{figure}
	...
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics{images/pelvisEstimationA.jpg}
		\caption{Położenie markerów}
		\label{fig:literature:vicon:pelvisPlacementA}
	\end{subfigure}	
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics{images/pelvisEstimationB.jpg}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.7\textwidth}
		\centering
		\includegraphics{images/nasaAircraft.png}
		\caption{Relatywny \cite{nasa2016}}
		\label{fig:appx:rot:eulerRel}
	\end{subfigure}	
	\begin{subfigure}[b]{0.7\textwidth}
		\centering
		\includegraphics{images/eulerAbsolute.png}
...
\begin{figure}  [!htp] 
	...
	\begin{subfigure}[b]{0.8\textwidth}
		\centering
		\includegraphics{images/kinectRotation.png}
	...
	\begin{subfigure}[b]{0.8\textwidth}
		\centering
		\includegraphics{images/kinectRightHandElbowAngle.png}
...
\begin{figure}[!htp]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics{images/memsAccelerometerStructure.png}
		\caption{Struktura wewnętrzna \cite{memsAccStructure2016}}
		\label{fig:characteristics:imu:acc:memsA}
	\end{subfigure}	
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics{images/memsAccelerometerIdea.png}
...
\begin{figure}[!htp]
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics{images/memsGyroscopeStructure.jpg}
		\caption{Struktura wewnętrzna \cite{memsGyroscopeStructure}}
		\label{fig:characteristics:imu:gyro:memsA}
	\end{subfigure}	
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics{images/memsGyroscopeIdea.jpg}
		\caption{Wizualizacja budowy \cite{memsAccIdea2016}}
