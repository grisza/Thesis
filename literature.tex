...
\begin{table}[]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		\cline{3-6} 
		\rowcolor[HTML]{EFEFEF} 
		\multirow{-2}{*}{\cellcolor[HTML]{EFEFEF}Klasa czujnika} & \multirow{-2}{*}{\cellcolor[HTML]{EFEFEF}Błąd pomiarów {[}$ 10^{-3}$g{]}} & 1 s & 10 s & 60 s & 1 godz. \\ 
		\hline
...
\begin{savenotes}
	\begin{figure}[!htb]
		...
		\caption[Rozmieszczenie środków mas poszczególnych części ciała człowieka według propozycji Zatsiorskiego i~Seluyanova oraz de Leva]{Rozmieszczenie środków mas (ŚM) poszczególnych części ciała człowieka według propozycji Zatsiorskiego i~Seluyanova (lewo) oraz de Leva (prawo) \cite{DeLeva1996}}	
...
\begin{savenotes}
	...
	\centering
		...
		\begin{subfigure}[b]{0.7\textwidth}
			...
			\caption[Wizualizacja budowy akcelerometru]{Wizualizacja budowy\footnote{\label{footnote:memsAccIdea2016}\fullcite{footnote:memsAccIdea2016}}}
...
\begin{savenotes}
	\begin{figure}[!htb]
		...
		\begin{subfigure}[b]{0.6\textwidth}
			...
			\caption[Wizualizacja budowy żyroskopu]{Wizualizacja budowy\cref{footnote:memsAccIdea2016}}
...
\end{equation}
gdzie: $H$ jest macierzą definiującą powiązanie pomiędzy dwoma kolejnymi pomiarami kontrolera Kinect (autorzy zdefiniowali ją jako macierz jednostkową), $R$ to macierz kowariancji kontrolera Kinect wyznaczona według wzoru \ref{eq:kalman:matrixR}, a~$P$ to macierz kowariancji czujników inercyjnych. Wartość współczynnika $\kappa$ we wzorze \ref{eq:kalman:matrixR} została przez autorów artukułu wyznaczona empirycznie na $15$.
