...
\begin{figure}[!htp]
	...
	\caption{Zestaw znaczników pasywnych w~systemie Vicon umieszczonych na ciele aktora w~trakcie sesji śledzenia ruchu \footfullcite{footnote:ViconMarkersSet}}
...
\begin{figure}[!htp]
	...
	\caption{Pasywne markery wykorzystywane w~optycznych systemach śledzenia ruchu\footfullcite{footnote:QulisysMarkers}}		
...
\begin{figure}[!htp]
	...
	\caption{Przykładowa konfiguracja systemu LPM firmy Inmotio\footfullcite{footnote:inmotio}}	
...
\begin{figure}
	...
	\caption{Układ współrzędnych wykorzystywany w~kontrolerze Microsoft Kinect \footfullcite{footnote:msdn:kinectCoordSpace2016}}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\caption{Relatywny \footfullcite{footnote:nasa2016}}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\caption{Absolutny \\footfullcite{footnote:Baker2015}}
...
\begin{figure}
	...
	\caption{Uproszczony schemat budowy kontrolera Microsoft Kinect v.1 \footfullcite{footnote:kinectFixit2016}}
...
\begin{figure}
	...
	\begin{minipage}[b]{0.48\linewidth}
		...
		\caption{Scena oświetlona promieniami IR\footfullcite{footnote:flatley2011}}
		\label{fig:characteristics:kinect:nightVision}
	\end{minipage}
	\begin{minipage}[b]{0.48\linewidth}
		\centering 
		\includegraphics[width=\textwidth]{images/kinect-pattern_3x3.png}
		\caption{Wzorzec oświetlenia sceny przez kontroler Kinect \footfullcite{footnote:reichinger2011}}
...
\begin{table}[!htp]
	\caption{Zestawienie podstawowych parametrów pracy układu MPU-6050\footfullcite{footnote:ivenSense:MPU6050}}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{images/memsAccelerometerStructure.png}	
		\caption{Struktura wewnętrzna \footfullcite{footnote:memsAccStructure2016}}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\caption{Wizualizacja budowy \footfullcite{footnote:memsAccIdea2016}}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{images/memsGyroscopeStructure.jpg}	
		\caption{Struktura wewnętrzna \footfullcite{footnote:memsGyroStructure2016}}
		\label{fig:characteristics:imu:gyro:memsA}
	\end{subfigure}
					
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{images/memsGyroscopeIdea.jpg}		
		\caption{Wizualizacja budowy \footfullcite{footnote:memsAccIdea2016}}
...
W omawianym rozwiązaniu autorzy zdecydowali się na wykorzystanie urzdzeń inercyjnych stworzonych przez firmę X-IO Technologies \footfullcite{footnote:xIo}. Urządzenia inercyjne firmy X-IO Technologies to układy zbudowane na bazie czujników inercyjnych oraz czujników inercyjnych wspieranych przez czujnik magnetyczny. Łączenie danych z~tych czujników, mające na celu określić orientację przestrzenną urządzenia, stosuje autorską metodę założyciela tej firmy, nazwaną jego nazwiskiem -- metodę Madgwicka.\\
