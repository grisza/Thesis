...
\end{figure}
		...
		\begin{savenotes}
\begin{table}[!htb]
	\caption{Współczynniki konwersji bezpośrednich pomiarów akcelerometru (a) i żyroskopu (b) w~zależności od przyjętego zakresu pracy\footfullcite{footnote:ivenSense:MPU6050}}
...
\begin{savenotes}
	\begin{figure}[!htb]																													
		\centering 
		\includegraphics[width=0.9\textwidth]{images/imumeasuredAngles.png}
...
\begin{savenotes}
	\begin{figure}[!htb]
		\centering 
		\includegraphics[width=0.9\textwidth]{images/imuDrift.png}
